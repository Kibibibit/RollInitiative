...
// 				return err
// 			}
// 			g.SetCurrentView(ui.MAIN_TABLE_NAME)
// 			return nil
// 		}); err != nil {
// 		log.Panicln(err)
// 	}
...
// 	return switchToViewCreatureWindow(g, v, NewViewCreatureWidget(VIEW_CREATURE_NAME, 120, 50, models.Creature{Name: line}, ADD_CREATURE_NAME))
